...
A **vellum** scene is not a stream of drawing commands that runs once and is
gone. It is a retained graph: every grob and viewport stays addressable after
you draw it. Give a node a `name` and you can find it again, read its
properties, and rewrite them, leaving the rest of the scene untouched.
