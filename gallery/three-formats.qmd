...
description: "The same vellum scene rendered to PNG, SVG, and PDF, with identical geometry from one Rust-backed backend."
categories: [Backend]
...
with consistent geometry and text shaping, and no per-format fiddling.
