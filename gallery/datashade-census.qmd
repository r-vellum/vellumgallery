...
The showcase for `mark_datashade()`: one point per person from the 2010 US
Census, about **306 million rows**, rendered as a map. It reproduces
...
wide dynamic range across the colour ramp so both empty plains and dense cities
stay legible.
